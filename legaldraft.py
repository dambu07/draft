...
def main():
    ...
    if type == "Custom":
        ...
        disclaimer2 = "If the bot does not response is not valid or incorrect please click the draft button again"

        st.markdown(f"<p style='color:red;'>Disclaimer: {disclaimer}</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color:red;'>Disclaimer: {disclaimer2}</p>", unsafe_allow_html=True)
        ...
        disclaimer = "If the bot does not response is not valid or incorrect please click the draft button again"
        st.write("Please ensure you have entered all information accurately.")
        st.markdown(f"<p style='color:red;'>Disclaimer: {disclaimer}</p>", unsafe_allow_html=True)
